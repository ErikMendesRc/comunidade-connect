...
import { FaUser, FaUsers, FaEnvelope, FaSignOutAlt, FaEdit, FaCircle, FaComment } from 'react-icons/fa';
...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="fixed top-16 left-0 z-40 w-64 h-[calc(100%-4rem)] bg-neutral-dark" aria-label="Sidebar">
